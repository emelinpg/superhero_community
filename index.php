<?php 
require_once 'php/cookie_login.php';
	if ($logged == true) {
			...
			<div id="container">
				<div class="header">
					<nav class="nav_menu">
						...
						<?php
						if ($logged){ echo "<a href='php/ranking.php' > Rankings</a>";}
						?>
						<a href='php/register.php'> Registry</a>
						<a href="#" style="word-spacing: 2px;">Hall of Fame</a> 
						<?php
						if($logged){echo '<a href="#">Forum</a>';}
						?>
						<?php
						if($logged){echo '<a href="#">Locate</a>' ;}
						?>
